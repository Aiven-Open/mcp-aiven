...
import { HOST, parseScopes, isMaintenanceMode, isExtraProtectionEnabled, loadEdgeAuthSecret } from './config.js';
...
export function startHttpServer(
  ...
  app.post('/mcp', mcpPostBearerRateLimit, authMiddleware, mcpJsonParser, (req: Request, res: Response) => {
